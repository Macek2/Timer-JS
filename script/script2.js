...
setInterval(function() {
        updateCountdown("remaining-time1", 300);
        updateCountdown("remaining-time2", 480);
        updateCountdown("remaining-time3", 270);
        updateCountdown("remaining-time4", 320);
        updateCountdown("remaining-time5", 420);
        updateCountdown("remaining-time6", 270);
        updateCountdown("remaining-time7", 300);
